...
const startDataLight = [
  ...
  { duration: "2 nights", value: 3, color: "#f97316" },
  { duration: "3 nights", value: 5, color: "#eab308" },
  { duration: "4-5 nights", value: 4, color: "#84cc16" },
  { duration: "6-7 nights", value: 7, color: "#22c55e" },
  { duration: "8-14 nights", value: 0, color: "#14b8a6" },
  { duration: "15-21 nights", value: 2, color: "#3b82f6" },
...
function DurationChart({ confirmedStays }) {
  ...
  // If confirmedStays is undefined or empty, fall back to an empty array
