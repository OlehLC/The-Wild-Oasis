...
import { eachDayOfInterval, subDays, isSameDay } from "date-fns"; // Import missing date-fns functions
...
function SalesCart({ bookings, numDays }) {
...
// PropTypes validation for 'bookings' and 'numDays' props
SalesCart.propTypes = {
